...
public class ShooterShoot extends CommandBase {
	...
	protected void execute() {
		// int delta = shooter.getEnc() - lastMeasurement; // pulses per 1/20th
		// of a sec (should be 83 @ 5000 RPM)
		// lastMeasurement = shooter.getEnc();
		// targetSpeed = oi.getFireButton() ? Constants.D_SHOOTER_FIRE :
		// Constants.D_SHOOTER_REST;

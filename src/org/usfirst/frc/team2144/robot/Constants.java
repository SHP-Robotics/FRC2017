...
public class Constants {
	...
	// PID
	public static double K_GEAR_P = 15;
	public static double K_GEAR_I = 0;
	public static double K_GEAR_D = 0;
	...
	public static double D_GEAR_OPEN = 0.2377;
	public static double D_GEAR_CLOSE = 0.1154;
}
